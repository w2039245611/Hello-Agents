...
class MySimpleAgent(SimpleAgent):
    ...
    def run(self, input_text: str,max_tool_iteration: int = 3, **kwargs) -> str:
        ...
        :param input_text:
        :param max_tool_iteration: 最大迭代次数
        :param kwargs:
        :return:
        """
    ...
    def _get_enhanced_system_prompt(self)->str:
        ...
        :return:
        """
        base_prompt=  self.system_prompt or "你是一个有用的Al助手。"
    ...
    def _run_with_tools(self, messages:list, input_text:str, max_tool_iteration:int, **kwargs):

        """
        支持工具调用的运行逻辑
        :param messages:    对话历史消息列表
        :param input_text:  用户本次输入的文本
        :param max_tool_iteration:  工具调用的最大迭代次数
        :param kwargs:
        :return:   模型本次回复的内容
        """
